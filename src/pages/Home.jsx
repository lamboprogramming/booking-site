...
const Home = () => {
  ...
  return (
    ...
    <div className="grid py-1 m-4 leading-10 text-center">
     ...
     <p className="text-xl italic leading-10 tracking-widest text-white uppercase shadow-md md:text-2xl lg:text-3xl md:mb-4">Private Events, Weddings, Baby Showers, Corporate Events, Retreats, Grand Openings, Holiday Parties,Pop-up Shops, Gaming Events, & More !  </p>
